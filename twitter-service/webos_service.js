...
var service = new Service('twitter.com.connect.app.service');
var greeting = 'Hello, World!';

service.register('auth/test', function(socket) {
  ...
  var activitySpec = {
    'activity': {
      ...
      'callback': {          // what service to call when this activity starts
        'method': 'luna://twitter.com.connect.app.service/pong', // URI to service
